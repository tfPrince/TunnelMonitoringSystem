<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnergyDay.aspx.cs" Inherits="suidaozhaoming.EnergyDay" %>
...
<form id="form1" runat="server">
    ...
    <div id="body_full" align="center" style="width:1270px; margin-left:-640px; position:absolute;left:50%;height:1014px; background-color:#000">
        ...
        <asp:image ID="Image1" runat="server" ImageUrl="~/Draw4.aspx" style=" width:1000px; height:680px;" ></asp:image>
