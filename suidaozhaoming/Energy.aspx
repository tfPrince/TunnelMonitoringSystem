<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Energy.aspx.cs" Inherits="suidaozhaoming.Energy" %>
    ...
    <div id="body_full" align="center" style="width:1270px; margin-left:-640px; position:absolute;left:50%;height:1014px; background-color:#000">
        <div id="head" style=" background-image:url(pic/headline.png);background-repeat:repeat-x; width:100%; height:90px " >
                ...
                <div style="width:740px; float:left; height:48px; float:left; margin-left:10px;">
                        <div style="width:460px; float:left; height:48px; float:left; margin-left:10px;">
                            ...
                            <ContentTemplate>
                                    ...
                                    <asp:Label ID="showtimeEnergy" runat="server" style=" background-color:transparent; color:#CCC; font:Tahoma, Geneva, sans-serif; font-size:44px;" >
                                    </asp:Label>              
                            </ContentTemplate>
                            </asp:UpdatePanel>
                        </div>
            ...
            <div align = "right" style="margin-right:15px; padding-top:11px; height:68px; width:97px; float:right">            
                <asp:ImageButton  ID="ButtonpEnergy_Exit" runat="server" OnClick = "Energy_Exit_Click" ImageUrl = "~/pic/Exit.png" onmouseout="changeback1(this)" onmouseover="changeImg1(this)" style="height:68px; width:97px; border:none;outline:none; background-color:transparent;" />               
            </div>    
        </div>
        ...
        <asp:image ID="Image1" runat="server" ImageUrl="~/Draw3.aspx" style=" width:1000px; height:680px;" ></asp:image>

        <div style="width:1000px; height:60px; text-align:left; margin-top:20px;">
                    <asp:TableCell style="text-align:left; width:40px; color:White; font-weight:bold; font-family:'仿宋'; font-size:34px;margin-left:20px;margin-top:20px;" >用电量记录时间:</asp:TableCell>
                   ...
                   <asp:DropDownList ID="DropDownList4" runat="server" style="width:80px; color:Black; font-weight:bold; outline:none; font-family:'仿宋'; font-size:34px;">
                    ...
                    <asp:TableCell style="width:160px;text-align: center;margin-left:260px;" >
