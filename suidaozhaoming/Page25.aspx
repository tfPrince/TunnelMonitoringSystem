<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Page25.aspx.cs" Inherits="suidaozhaoming.Page25" %>
...
<div id="body_full" align="center" style="width:1270px; margin-left:-640px; position:absolute;left:50%;height:1014px; background-color:#000">
        ...
        <div id="head" style=" background-image:url(pic/headline.png);background-repeat:repeat-x; width:100%; height:90px " >
            ...
            <div align = "right" style="margin-right:15px; padding-top:11px; height:68px; width:97px; float:right">
                ...
                <asp:ImageButton  ID="ButtonPage25_Exit" OnClick = "ButtonPage25_Exit_Click" ImageUrl ="/pic/Exit.png" onmouseout="changeback(this)" onmouseover="changeImg(this)"  runat="server"  style="float:left; background-color:transparent;height:68px; width:97px; border:none; background-color:transparent; margin-left: 0px" />
            
            </div>   
        </div>
        <div id="titlefeed" style="width:100%;margin-top:10px;text-align: center">
            <asp:Label ID="title" runat="server" style="color:#CCC; font:Tahoma, Geneva, sans-serif;font-size:48px; font-weight:bold; margin-left:0px;">洞外亮度数据月报表</asp:Label>
...
<div style="width:1270px;height:855px;border:none" id="container">
    <asp:Panel ID="pn" runat="server" Height="700px" ScrollBars="Both" Width="1270px" style="margin-top:1px;text-align: center">
            ...
            <div style="width:1100px; height:60px; text-align:left; margin-top:20px;">
                    ...
                    <asp:TableCell style="text-align:left; width:40px; color:White; font-weight:bold; font-family:'仿宋'; font-size:34px;margin-left:20px;margin-top:20px;" >月亮度曲线时间:</asp:TableCell>
