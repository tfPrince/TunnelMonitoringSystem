<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Page133.aspx.cs" Inherits="suidaozhaoming.Page133" %>
    ...
    <div id="body_full" align="center" style="width:1270px; margin-left:-640px; position:absolute;left:50%;height:1014px; background-color:#000">
        <div id="head" style=" background-image:url(pic/headline.png);background-repeat:repeat-x; width:100%; height:90px " >
            ...
            <div align = "right" style="margin-right:15px; padding-top:11px; height:68px; width:97px; float:right">
                ...
                <asp:ImageButton  ID="ButtonpP13_Exit" runat="server" OnClick = "ButtonP13_Exit_Click" ImageUrl = "~/pic/Exit.png" onmouseout="changeback1(this)" onmouseover="changeImg1(this)" style="height:68px; width:97px; border:none; outline:none; background-color:transparent;" />
        ...
        <div align="center" style=" width:1140px; height:850px;margin-left:-570px; position:absolute; left:50%; ">
            ...
            <div style=" width:1000px; height:600px; text-align:center;  background-image:url(pic/Jobmanage-3.png); margin-top:0px" >
                    ...
                    <asp:TableCell style="width:100px; padding-left:10px;color:Black; font-weight:bold; font-family:@仿宋; font-size:28px;margin-left:20px;margin-top:70px; ">序号：</asp:TableCell>
                    ...
                    <asp:DropDownList ID="Emp_Lim"  runat="server" 
                    ...
                    <asp:TextBox ID="TextBox1"  style="text-align:center; width:474px; height:40px;font-family:'仿宋'; margin-left:10px; margin-top:30px; border:none;outline:none; background-color:transparent; font-size:28px"  runat="server"></asp:TextBox>
             ...
             <asp:Table ID="firstpagecaozuo" runat="server" width="1080px" style= "border:0px;margin-top:0px">
                <asp:TableRow style="height:100px;">
                    ...
                    <asp:TableCell style="width:220px;text-align: center" >
                    <asp:Button ID="Ent_Emp"  OnClick = "Ent_Click" Enabled = "false" runat="server" Text = "Enter" onmouseover= "this.style.color = '#000';" onmouseout = "this.style.color ='#FFF';" style="background-image:url(pic/KeyBoard_1.png);background-color:transparent;padding-left:0px; width:160px; height:54px; border:none;color:#FFF; font-weight:bold; font-family:'仿宋'; font-size:30px;text-align: center " />
                    </asp:TableCell>
                    <asp:TableCell style="width:220px;text-align: center" >
                    <asp:Button ID="Can_Emp"  OnClick = "Can_Click" Enabled = "false" runat="server" Text ="Cancel" onmouseover= "this.style.color = '#000';" onmouseout = "this.style.color ='#FFF';" style="background-image:url(pic/KeyBoard_1.png);background-color:transparent;padding-left:0px; width:160px; height:54px; border:none;color:#FFF; font-weight:bold; font-family:'仿宋'; font-size:30px;text-align: center " />
                    </asp:TableCell>
                </asp:TableRow>
        </asp:Table>
