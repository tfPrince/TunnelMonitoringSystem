<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Page27.aspx.cs" Inherits="suidaozhaoming.Page27" %>
...
<form id="form1" runat="server">
    ...
    <div id="body_full" align="center" style="width:1270px; margin-left:-640px; position:absolute;left:50%;height:1014px; background-color:#000">
        ...
        <asp:image runat="server" ImageUrl="~/Draw1.aspx" style=" width:1000px; height:680px;" ></asp:image>
